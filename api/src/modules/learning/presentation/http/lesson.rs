...
use crate::modules::learning::application::use_cases::lesson::queries::get_lesson_by_course_id::{GetLessonByCourseIdError,GetLessonByCourseIdQueryHandler,GetLessonByCourseIdQuery};
use crate::modules::learning::application::use_cases::lesson::queries::get_lesson_by_id::{GetLessonByIdError,GetLessonByIdQuery,GetLessonByIdQueryHandler};
use crate::modules::learning::application::use_cases::lesson::queries::get_lesson_by_slug::{GetLessonBySlugError,GetLessonBySlugQuery,GetLessonBySlugQueryHandler};
...
pub async fn get_lesson_by_course_id(
    ...
    match handler.handle(GetLessonByCourseIdQuery{ id: course_id }).await {
        Ok(lesson) => (
            StatusCode::OK,
            Json(json!({
                "data": lesson
